...
{
    if(ID.Value &&
       (AtomicCompareExchangeUInt32((uint32 *)&Assets->Slots[ID.Value].State, AssetState_Queued, AssetState_Unloaded) == AssetState_Unloaded))
    {
...
internal game_assets * AllocateGameAssets(memory_arena *Arena, memory_index Size, transient_state *TranState)
{
    ...
    if(ReadResult.ContentsSize != 0)
    {
        ...
        // TODO: Dexide what will be flat-loaded and what won't be!
