...
inline entity_basis_p_result GetRenderEntityBasisP(render_group *RenderGroup, render_entity_basis *EntityBasis, v2 ScreenCenter)
{
    ...
    // TODO: The values of 20 and 20 seem wrong - I think I did something wrong.
...
#else
                DrawRectangleSlowly(OutputTarget, Basis.P, Basis.Scale * V2i(Entry->Bitmap->Width, 0), Basis.Scale * V2i(0, Entry->Bitmap->Height), Entry->Color,
                                    Entry->Bitmap,
                                    0, 0, 0, 0,
                                    PixelsToMeters);
#endif
