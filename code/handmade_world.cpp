...
inline bool32 AreInSameChunk(world *World, world_chunk *A, world_position *B)
{
    Assert(IsCanonical(World, B->Offset_));
...
inline void ChangeEntityLocation(memory_arena *Arena, world *World, uint32 LowEntityIndex, low_entity *LowEntity, world_position NewPInit)
{
