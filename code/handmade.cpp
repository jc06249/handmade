...
extern "C" GAME_UPDATE_AND_RENDER(GameUpdateAndRender)
{
    ...
    for(int RelRow = -10; RelRow < 10; ++RelRow)
    {
        for(int RelColumn = -20; RelColumn < 20; ++RelColumn)
        {
            ...
            real32 CenX = SreenCenterX - (TileMap->MetersToPixels * GameState->PlayerP.TileRelX) + ((real32)RelColumn) * TileMap->TileSideInPixels;
            real32 CenY = SreenCenterY + (TileMap->MetersToPixels * GameState->PlayerP.TileRelY) - ((real32)RelRow) * TileMap->TileSideInPixels;
    ...
    real32 PlayerG = 1.0f;
    real32 PlayerB = 0.0f;
    real32 PlayerLeft = SreenCenterX  - (0.5f * TileMap->MetersToPixels * PlayerWidth);
