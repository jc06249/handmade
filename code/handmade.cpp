...
extern "C" GAME_UPDATE_AND_RENDER(GameUpdateAndRender)
{
    ...
    // v2 YAxis = Perp(XAxis);
    v2 YAxis = (50.0f + 50.0f*Cos(Angle)) * V2(Cos(Angle + 1.f), Sin(Angle + 1.f));
    uint32 PIndex = 0;
    render_entry_coordinate_system *C = CoordinateSystem(RenderGroup, Origin, XAxis, YAxis, V4(0.5f + 0.5f * Sin(Angle), 0.5f + 0.5f * Sin(2.9f * Angle), 0.5f + 0.5f * Sin(9.9f * Angle), 1));
