...
extern "C" GAME_UPDATE_AND_RENDER(GameUpdateAndRender)
{
    ...
    {
        InitializeArena(&TranState->TranArena, Memory->TransientStorageSize - sizeof(game_state), (uint8 *)Memory->TransientStorage + sizeof(game_state));
    ...
    DrawRectangle(DrawBuffer, Diff.XY, V2(10.0f, 10.f), 1.0f, 1.0f, 0.0f);
